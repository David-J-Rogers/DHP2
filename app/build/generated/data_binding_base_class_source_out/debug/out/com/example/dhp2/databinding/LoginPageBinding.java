...
public final class LoginPageBinding implements ViewBinding {
  ...
  private LoginPageBinding(@NonNull LinearLayout rootView, @NonNull SignInButton googleSignInButton,
      @NonNull Button loginButton, @NonNull EditText passwordEditText, @NonNull Button signUpButton,
  ...
  public static LoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoginPageBinding((LinearLayout) rootView, googleSignInButton, loginButton,
